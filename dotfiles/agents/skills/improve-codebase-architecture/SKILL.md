...
**Use precise vocabulary for the domain, and [language.md](language.md) vocabulary for the architecture.** If we discuss "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service."
